...
import gridConfiguration2.GridConfig;
...
public class Simulator {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Please enter the arrival rate Lambda for Coordinated Scheduling : ");
	...
	public static void initializeSimulation() throws Exception{
		...
		//EventList.queue(e3);
		System.out.println("Coordinated Traffic Simulation started");
		startSimulation();
	}
